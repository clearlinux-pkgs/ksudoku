...
Version  : 23.08.3
Release  : 62
URL      : https://download.kde.org/stable/release-service/23.08.3/src/ksudoku-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/ksudoku-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/ksudoku-23.08.3.tar.xz.sig
...
%prep
%setup -q -n ksudoku-23.08.3
cd %{_builddir}/ksudoku-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699554329
mkdir -p clr-build
pushd clr-build
