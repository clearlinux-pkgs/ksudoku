...
%prep
%setup -q -n ksudoku-21.12.1
cd %{_builddir}/ksudoku-21.12.1
...
cp %{_builddir}/ksudoku-21.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/ksudoku/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang ksudoku
