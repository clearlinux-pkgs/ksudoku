...
Version  : 24.05.2
Release  : 72
URL      : https://download.kde.org/stable/release-service/24.05.2/src/ksudoku-24.05.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/ksudoku-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/ksudoku-24.05.2.tar.xz.sig
...
%setup -q -n ksudoku-24.05.2
cd %{_builddir}/ksudoku-24.05.2
pushd ..
cp -a ksudoku-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720566901
mkdir -p clr-build
pushd clr-build
