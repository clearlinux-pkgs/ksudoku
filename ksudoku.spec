...
Version  : 22.12.2
Release  : 50
URL      : https://download.kde.org/stable/release-service/22.12.2/src/ksudoku-22.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/ksudoku-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/ksudoku-22.12.2.tar.xz.sig
...
%prep
%setup -q -n ksudoku-22.12.2
cd %{_builddir}/ksudoku-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675641988
mkdir -p clr-build
pushd clr-build
