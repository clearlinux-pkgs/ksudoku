...
Version  : 25.04.1
Release  : 84
URL      : https://download.kde.org/stable/release-service/25.04.1/src/ksudoku-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/ksudoku-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/ksudoku-25.04.1.tar.xz.sig
...
%setup -q -n ksudoku-25.04.1
cd %{_builddir}/ksudoku-25.04.1
pushd ..
cp -a ksudoku-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747091733
mkdir -p clr-build
pushd clr-build
