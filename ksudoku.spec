...
Version  : 19.04.1
Release  : 9
URL      : https://download.kde.org/stable/applications/19.04.1/src/ksudoku-19.04.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.1/src/ksudoku-19.04.1.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.1/src/ksudoku-19.04.1.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1557454301
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
