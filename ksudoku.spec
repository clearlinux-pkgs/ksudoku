...
Version  : 19.04.0
Release  : 8
URL      : https://download.kde.org/stable/applications/19.04.0/src/ksudoku-19.04.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.0/src/ksudoku-19.04.0.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.0/src/ksudoku-19.04.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1557032483
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
