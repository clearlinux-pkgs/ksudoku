...
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/ksudoku-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/ksudoku-23.04.1.tar.xz.sig
...
%prep
%setup -q -n ksudoku-23.04.1
cd %{_builddir}/ksudoku-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685599024
mkdir -p clr-build
pushd clr-build
