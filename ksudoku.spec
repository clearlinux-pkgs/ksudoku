...
Version  : 20.04.2
Release  : 22
URL      : https://download.kde.org/stable/release-service/20.04.2/src/ksudoku-20.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.04.2/src/ksudoku-20.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.2/src/ksudoku-20.04.2.tar.xz.sig
...
%prep
%setup -q -n ksudoku-20.04.2
cd %{_builddir}/ksudoku-20.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591893508
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksudoku-20.04.2/COPYING %{buildroot}/usr/share/package-licenses/ksudoku/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/ksudoku-20.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/ksudoku/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang ksudoku
