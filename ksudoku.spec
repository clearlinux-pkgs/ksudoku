...
Source0  : https://download.kde.org/stable/applications/19.08.1/src/ksudoku-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/ksudoku-19.08.1.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567710430
mkdir -p clr-build
pushd clr-build
