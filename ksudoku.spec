...
Version  : 24.12.2
Release  : 81
URL      : https://download.kde.org/stable/release-service/24.12.2/src/ksudoku-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/ksudoku-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/ksudoku-24.12.2.tar.xz.sig
...
%setup -q -n ksudoku-24.12.2
cd %{_builddir}/ksudoku-24.12.2
pushd ..
cp -a ksudoku-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738952278
mkdir -p clr-build
pushd clr-build
