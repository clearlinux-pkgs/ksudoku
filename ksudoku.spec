...
Version  : 23.08.5
Release  : 65
URL      : https://download.kde.org/stable/release-service/23.08.5/src/ksudoku-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/ksudoku-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/ksudoku-23.08.5.tar.xz.sig
...
%prep
%setup -q -n ksudoku-23.08.5
cd %{_builddir}/ksudoku-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708380551
mkdir -p clr-build
pushd clr-build
